...
!!
!! 2021.04.26 Kurama Okubo (kokubo@bosai.go.jp) developped m_vmodel_biax.F90
!!
!<
!! ----
module m_vmodel_biax_sidecoord
...
contains
  ...
  !<
  !! ----
  subroutine vmodel_biax_sidecoord( io_prm, i0, i1, j0, j1, k0, k1, xc, yc, zc, vcut, rho, lam, mu, Qp, Qs, bd )
    ...
    real(SP) :: balldrop_w, balldrop_h, balldrop_hm, balldrop_htm, topo0 !,balldrop_l, balldrop_lm,
    ...
    call readini( io_prm, 'balldrop_htm',  balldrop_htm,  40.0e-6 )
      ...
      do i = i0, i1
        ...
        do k = k0, k1
          ...
          if( zc(k) < 0 .or. zc(k) > balldrop_w ) then
            ...
            lam(k,i,j) = rho(k,i,j) * ( vp_metal*vp_metal - 2*vs_metal*vs_metal )
  ...
  end subroutine vmodel_biax_sidecoord
  !! --------------------------------------------------------------------------------------------------------------------------- !!


end module m_vmodel_biax_sidecoord
!! ----------------------------------------------------------------------------------------------------------------------------- !!
