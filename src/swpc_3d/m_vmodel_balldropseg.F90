...
contains
  ...
  !<
  !! ----
  subroutine vmodel_balldropseg( io_prm, i0, i1, j0, j1, k0, k1, xc, yc, zc, vcut, rho, lam, mu, Qp, Qs, bd )
    ...
    do j = j0, j1
      do i = i0, i1
        ...
        do k = k0, k1
          ...
          if( yc(j) > 0 .or. yc(j) < -balldrop_w ) then
  ...
  end subroutine vmodel_balldropseg
  !! --------------------------------------------------------------------------------------------------------------------------- !!


end module m_vmodel_balldropseg
!! ----------------------------------------------------------------------------------------------------------------------------- !!
