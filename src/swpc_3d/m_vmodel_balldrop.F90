...
contains
  ...
  !<
  !! ----
  subroutine vmodel_balldrop( io_prm, i0, i1, j0, j1, k0, k1, xc, yc, zc, vcut, rho, lam, mu, Qp, Qs, bd )
    ...
    real(SP) :: balldrop_l, balldrop_w, balldrop_h, balldrop_lm, balldrop_hm, topo0
